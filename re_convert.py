...
if __name__ == '__main__':
    ...
    model_path = "C:\\Users\\Breeze\\Desktop\\keras-yolo3-master\\model_data\\trained_weights_final_5141.h5"     # keras yolov3 h5 model file
    config_path = 'yolov3.cfg'                   # .cfg  file path
    weight_file = open('yolov_5141.weights', 'wb')   # save darknet yolov3 weights file path
